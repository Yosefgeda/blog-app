...
[BLOG-APP]  ROR app created to impliment data models for upcoming fully functional blog app.  
...
To clone: git clone git@github.com:yosefgeda/blog-app.git
to change to directory: cd blog-app
...
- [ ] **[Project_will_show_the_list_of_posts]**
- [ ] **[adding comments and liking posts functionalities will be added]**
...
Feel free to check the [issue page](https://github.com/yosefgeda/blog-app/issues)
