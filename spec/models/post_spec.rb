...
RSpec.describe Post, type: :model do
  ...
  it 'five recent comments' do
    ...
    expect(post.five_recent_comments.size).to eq(5)
    expect(post.five_recent_comments[0].text).to eq('This is my fifth comment')
    expect(post.five_recent_comments[1].text).to eq('This is my fourth comment')
  end
end
